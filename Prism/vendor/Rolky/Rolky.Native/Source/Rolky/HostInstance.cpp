...
namespace Rolky {
    ...
    void HostInstance::LoadRolkyFunctions()
    {
        ...
        s_ManagedFunctions.BuildProjectBlockingFptr = LoadRolkyManagedFunctionPtr<BuildProjectBlockingFn>(ROLKY_STR("Rolky.Managed.Build.BuildBridge, Rolky.Managed"), ROLKY_STR("BuildProjectBlocking"));
        s_ManagedFunctions.CleanProjectBlockingFptr = LoadRolkyManagedFunctionPtr<CleanProjectBlockingFn>(ROLKY_STR("Rolky.Managed.Build.BuildBridge, Rolky.Managed"), ROLKY_STR("CleanProjectBlocking"));
        s_ManagedFunctions.SetScriptBuildSettingsFptr = LoadRolkyManagedFunctionPtr<SetScriptBuildSettingsFn>(ROLKY_STR("Rolky.Managed.Build.BuildBridge, Rolky.Managed"), ROLKY_STR("SetScriptBuildSettings"));

        s_ManagedFunctions.GenerateProjectFptr = LoadRolkyManagedFunctionPtr<GenerateProjectFn>(ROLKY_STR("Rolky.Managed.Project.ProjectBridge, Rolky.Managed"), ROLKY_STR("GenerateProject"));
        s_ManagedFunctions.GenerateSolutionFptr = LoadRolkyManagedFunctionPtr<GenerateSolutionFn>(ROLKY_STR("Rolky.Managed.Project.ProjectBridge, Rolky.Managed"), ROLKY_STR("GenerateSolution"));
