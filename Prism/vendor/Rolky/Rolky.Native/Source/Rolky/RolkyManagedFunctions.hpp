...
#pragma region Builder
    using BuildProjectBlockingFn = Bool32(*)(String configuration, String platform, Bool32 rebuild);
    using CleanProjectBlockingFn = Bool32(*)(String configuration);
    using SetScriptBuildSettingsFn = void(*)(String solutionPath, String projectPath, String logsDirectory);
#pragma endregion Builder

#pragma region ProjectGenerator
    using GenerateProjectFn = void(*)(ProjectDesc* desc);
    using GenerateSolutionFn = void(*)(String outputDir, String solutionName, Array<ProjectDesc> projects);
#pragma endregion ProjectGenerator
...
#pragma region Builder
        BuildProjectBlockingFn BuildProjectBlockingFptr = nullptr;
        CleanProjectBlockingFn CleanProjectBlockingFptr = nullptr;
        SetScriptBuildSettingsFn SetScriptBuildSettingsFptr = nullptr;
#pragma endregion Builder

#pragma region ProjectGenerator
        GenerateProjectFn GenerateProjectFptr = nullptr;
        GenerateSolutionFn GenerateSolutionFptr = nullptr;
#pragma endregion ProjectGenerator
