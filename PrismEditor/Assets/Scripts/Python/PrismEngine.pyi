...
class Image:
    ...
    def GetFormat(self) -> ImageFormat: ...
    def __repr__(self) -> str: ...
class Image2D(Image):
    @staticmethod
    def Create(format: ImageFormat, width: int, height: int,
               data: Optional[Any] = None, samples: int = 1) -> Image2D: ...
class ImageCube(Image):
    @staticmethod
    def Create(format: ImageFormat, width: int, height: int,
               data: Optional[Any] = None) -> ImageCube: ...
    def GenerateMipMap(self) -> None: ...
    def CopyTo(self, target: ImageCube) -> None: ...
class Texture(Asset):
    @property
    def Width(self) -> int: ...
    @property
...
class Texture2D(Texture):
    @staticmethod
    def Create(width: int, height: int) -> Texture2D: ...
    def SetData(self, data: Any) -> None: ...
    def GetImage(self) -> Image2D: ...
    def __repr__(self) -> str: ...
class TextureCube(Texture):
    @staticmethod
    def Create(format: ImageFormat, width: int, height: int,
               data: Optional[Any] = None) -> TextureCube: ...
    def GetImage(self) -> ImageCube: ...
    def __repr__(self) -> str: ...
class UniformType:
    None_ : int  # 运行时名称为 None
    Bool : int
    ...
    TextureCube : int
    Enum : int
class PrismShader(Asset):
    @staticmethod
    def GetShader(shaderName: str) -> PrismShader: ...
    @property
    def Name(self) -> str: ...
    def GetName(self) -> str: ...
    def GetUniformCount(self) -> int: ...
    def GetUniformType(self, index: int) -> UniformType: ...
    def GetUniformName(self, index: int) -> str: ...
    def GetUniformDisplayName(self, index: int) -> str: ...
    def GetUniformDefaultValue(self, index: int) -> Any: ...
    def __repr__(self) -> str: ...
class Material(Asset):
    @overload
    def __init__(self, handle: int) -> None: ...
    @overload
    def __init__(self, shader: PrismShader) -> None: ...
    def __repr__(self) -> str: ...
    ...
    def SetTexture2D(self, uniform: str, texture: Texture2D) -> None: ...
    def SetKeyword(self, name: str, enabled: bool) -> None: ...
    def IsKeywordEnabled(self, name: str) -> bool: ...
class UniformBuffer:
    @staticmethod
    def Create(size: int) -> UniformBuffer: ...
    def SetData(self, data: Any, offset: int = 0) -> None: ...
    def __repr__(self) -> str: ...
class MeshFactory:
    @staticmethod
